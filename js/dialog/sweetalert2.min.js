!(function (e, t) {
  ...
  function t() {
    null !== v.previousBodyPadding &&
      ((document.body.style.paddingRight = v.previousBodyPadding),
    ...
    return new Promise(function (n, i) {
      ...
      function s(t) {
        ...
        if (-1 !== [9, 13, 32, 27].indexOf(r)) {
          ...
          9 === r
            ? (n.shiftKey ? a(c, -1) : a(c, 1), N(n))
            : 13 === r || 32 === r
            ? -1 === c && (e.focusCancel ? H(V, n) : H(E, n))
            : 27 === r &&
              e.allowEscapeKey === !0 &&
              (o.closeModal(e.onClose), i("esc"));
        }
      }
      e.timer &&
      ...
      var c = function (n) {
          switch ((n = n || e.input)) {
            ...
            case "radio":
              return (
                t.querySelector("." + l.radio + " input:checked") ||
                t.querySelector("." + l.radio + " input:first-child")
              );
            case "range":
      ...
      var d,
        f = function (t) {
          e.showLoaderOnConfirm && o.showLoading(),
            e.preConfirm
        ...
        h = function (t) {
          ...
          switch (n.type) {
            ...
            case "mouseup":
              e.buttonsStyling &&
                (s
                  ? (a.style.backgroundColor = m(e.confirmButtonColor, -0.1))
                  : c &&
                    (l.style.backgroundColor = m(e.cancelButtonColor, -0.1)));
              break;
            case "mouseout":
              e.buttonsStyling &&
                (s
            ...
            case "mousedown":
              e.buttonsStyling &&
                (s
                  ? (a.style.backgroundColor = m(e.confirmButtonColor, -0.2))
                  : c &&
                    (l.style.backgroundColor = m(e.cancelButtonColor, -0.2)));
              break;
            case "click":
              if (s && o.isVisible())
                if (e.input) {
      ...
      (S().onclick = function () {
        ...
        (r.onclick = function (t) {
          t.target === r &&
            e.allowOutsideClick &&
            (o.closeModal(e.onClose), i("overlay"));
        });
      var E = C(),
        V = k();
      e.reverseButtons
        ? E.parentNode.insertBefore(V, E)
        : E.parentNode.insertBefore(E, V),
        (v.previousWindowKeyDown = window.onkeydown),
        (window.onkeydown = s),
        e.buttonsStyling &&
          ((E.style.borderLeftColor = e.confirmButtonColor),
          (E.style.borderRightColor = e.confirmButtonColor)),
        (o.showLoading = o.enableLoading =
          function () {
            q(b()),
              q(E, "inline-block"),
              P(E, "loading"),
        ...
        (o.hideLoading = o.disableLoading =
          function () {
            e.showConfirmButton || (M(E), e.showCancelButton || M(b())),
              A(E, "loading"),
              A(t, "loading"),
              (E.disabled = !1),
              (V.disabled = !1);
      ...
      switch (e.input) {
        ...
        case "checkbox":
          ...
          (ee.type = "checkbox"),
            (ee.value = 1),
            (ee.id = l.checkbox),
            (ee.checked = Boolean(e.inputValue));
          var te = X.getElementsByTagName("span");
          te.length && X.removeChild(te[0]),
            (te = document.createElement("span")),
            (te.innerHTML = e.inputPlaceholder),
            X.appendChild(te),
            q(X);
          break;
        case "textarea":
          var ne = L(t, l.textarea);
          (ne.value = e.inputValue),
            (ne.placeholder = e.inputPlaceholder),
            q(ne);
          break;
        case null:
          break;
      ...
      if (
        ...
        z(e.animation, e.onOpen),
        a(-1, 1),
        (r.scrollTop = 0),
        "undefined" != typeof MutationObserver && !p)
      ) {
        var oe = W(function () {
          o.recalculateHeight();
        }, 50);
        (p = new MutationObserver(oe)),
          p.observe(t, { childList: !0, characterData: !0, subtree: !0 });
      }
    });
  }
  function o() {
  ...
  var p,
    ...
    D = function () {
      var e = y();
      (window.onkeydown = v.previousWindowKeyDown),
    ...
    U = function (e) {
      ...
      e.showCloseButton ? q(u) : M(u),
        (t.className = l.modal),
        e.customClass && P(t, e.customClass);
      var p = w(),
        f = parseInt(
      ...
      e.progressSteps.length
        ? (q(p),
          ...
          e.progressSteps.forEach(function (t, n) {
            ...
            if (
              (P(o, l.progresscircle),
              (o.innerHTML = t),
              n === f && P(o, l.activeprogressstep),
              p.appendChild(o),
      ...
      if (e.type) {
        ...
        switch ((q(S), e.type)) {
          case "success":
            P(S, "animate"),
              P(S.querySelector(".tip"), "animate-success-tip"),
              P(S.querySelector(".long"), "animate-success-long");
            break;
          case "error":
            P(S, "animate-error-icon"),
              P(S.querySelector(".x-mark"), "animate-x-mark");
            break;
          case "warning":
            P(S, "pulse-warning");
        }
      ...
      e.imageUrl
        ? (x.setAttribute("src", e.imageUrl),
          q(x),
          e.imageWidth
            ? x.setAttribute("width", e.imageWidth)
            : x.removeAttribute("width"),
          e.imageHeight
            ? x.setAttribute("height", e.imageHeight)
            : x.removeAttribute("height"),
          (x.className = l.image),
          e.imageClass && P(x, e.imageClass))
        : M(x),
        e.showCancelButton ? (a.style.display = "inline-block") : M(a),
        e.showConfirmButton ? T(i, "display") : M(i);
      var E = b();
      e.showConfirmButton || e.showCancelButton ? q(E) : M(E),
        (i.innerHTML = e.confirmButtonText),
        (a.innerHTML = e.cancelButtonText),
        e.buttonsStyling &&
          ((i.style.backgroundColor = e.confirmButtonColor),
          (a.style.backgroundColor = e.cancelButtonColor)),
        (i.className = l.confirm),
        P(i, e.confirmButtonClass),
        (a.className = l.cancel),
        P(a, e.cancelButtonClass),
        e.buttonsStyling
          ? (P(i, "styled"), P(a, "styled"))
          : (A(i, "styled"),
            A(a, "styled"),
            ...
            (a.style.backgroundColor =
              ...
              a.style.borderRightColor =
                "")),
        e.animation === !0 ? A(t, "no-animation") : P(t, "no-animation");
    },
    z = function (t, n) {
      var o = y();
      t ? (P(o, "show-swal2"), P(r, "fade"), A(o, "hide-swal2")) : A(o, "fade"),
        q(o),
        (r.style.overflowY = "hidden"),
        j && !E(o, "no-animation")
          ? o.addEventListener(j, function i() {
              o.removeEventListener(j, i), (r.style.overflowY = "auto");
            })
          : (r.style.overflowY = "auto"),
        P(r, "in"),
        P(document.body, l["in"]),
        e(),
        (v.previousActiveElement = document.activeElement),
        null !== n && "function" == typeof n && n.call(this, o);
    };
  return (
    ...
    (o.close = o.closeModal =
      function (e) {
        var n = y();
        A(n, "show-swal2"), P(n, "hide-swal2");
        var o = n.querySelector("." + l.icon + "." + s.success);
        A(o, "animate"),
          A(o.querySelector(".tip"), "animate-success-tip"),
          A(o.querySelector(".long"), "animate-success-long");
        var i = n.querySelector("." + l.icon + "." + s.error);
        A(i, "animate-error-icon"),
          A(i.querySelector(".x-mark"), "animate-x-mark");
        var a = n.querySelector("." + l.icon + "." + s.warning);
        A(a, "pulse-warning"),
          D(),
          j && !E(n, "no-animation")
            ? n.addEventListener(j, function c() {
                n.removeEventListener(j, c),
                  E(n, "hide-swal2") &&
                    (M(n), A(r, "in"), A(document.body, l["in"]), t());
              })
            : (M(n), A(r, "in"), A(document.body, l["in"]), t()),
    ...
    (o.version = "5.0.7"),
    (window.sweetAlert = window.swal = o),
    (function () {
