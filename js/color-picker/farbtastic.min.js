...
jQuery._farbtastic = function (e, t) {
  ...
  n.mousemove = function (e) {
    ...
    if (n.circleDrag) {
      ...
      var i = Math.max(0, Math.min(1, -(t.x / n.square) + 0.5));
      var s = Math.max(0, Math.min(1, -(t.y / n.square) + 0.5));
  ...
  n.updateDisplay = function () {
    ...
    $(".sl-marker", r).css({
      left: Math.round(n.square * (0.5 - n.hsl[1]) + n.width / 2) + "px",
      top: Math.round(n.square * (0.5 - n.hsl[2]) + n.width / 2) + "px",
    });
    $(".color", r).css(
      "backgroundColor",
      n.pack(n.HSLToRGB([n.hsl[0], 1, 0.5]))
    );
    if (typeof n.callback == "object") {
      $(n.callback).css({
        backgroundColor: n.color,
        color: n.hsl[2] > 0.5 ? "#000" : "#fff",
      });
  ...
  n.HSLToRGB = function (e) {
    ...
    var o = e[0],
      u = e[1],
      a = e[2];
    n = a <= 0.5 ? a * (u + 1) : a + u - a * u;
    t = a * 2 - n;
    return [
      this.hueToRGB(t, n, o + 0.33333),
      this.hueToRGB(t, n, o),
      this.hueToRGB(t, n, o - 0.33333),
    ];
  };
  n.hueToRGB = function (e, t, n) {
    ...
    if (n * 2 < 1) return t;
    if (n * 3 < 2) return e + (t - e) * (0.66666 - n) * 6;
    return e;
  };
