(function ($) {
  ...
  $("button.btn.ant-nk-st.rotateInUpLeft-ac").on("click", function () {
    $(".animation-img .animate-eight")
      .addClass("animated rotateInUpLeft")
      .one(
        "webkitAnimationEnd mozAnimationEnd oAnimationEnd animationend",
        function () {
