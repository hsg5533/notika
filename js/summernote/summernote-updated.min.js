        ...
        k = {
          ...
          link: function (e, t) {
            var n =
                ...
                '</label><div class="nk-int-st"><input class="note-link-text form-control" type="text" /></div></div><div class="form-group row"><label>' +
                e.link.url +
                '</label><div class="nk-int-st"><input class="note-link-url form-control col-md-12" type="text" value="http://" /></div></div>' +
                (t.disableLinkTarget ? "" : ""),
              o =
